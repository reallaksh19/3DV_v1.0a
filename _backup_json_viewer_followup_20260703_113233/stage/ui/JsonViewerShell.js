...
export function createJsonViewerShell(root) {
  ...
  navRow.append(
    commandGroup('Navigate', [selectToolButton, orbitToolButton, panToolButton, fitButton, fitSelectionButton, marqueeZoomButton, measureToolButton]),
    ...
    commandGroup('Tags', [tagCreateButton, tagViewButton, tagImportButton, tagExportButton]),
    measureReadout,
  );

  const body = el('div', 'json-viewer-body', '');
  const leftPanel = el('aside', 'json-viewer-left-panel json-viewer-component-panel', '');
  leftPanel.append(el('h2', 'json-viewer-panel-title', 'Components'));
  ...
  leftPanel.append(treeFilterInput, componentFilters, hiddenList, hierarchyList);
  ...
  tabs.append(propertiesTab, tagsTab, clipTab, diagnosticsTab);
  ...
  rightPanel.append(tabs, propertiesPanel, tagsPanel, clipPanel, diagnosticsPanel);
  ...
  return { shell, toolbar, navRow, fileInput, rvmFileInput, tagFileInput, downloadButton, qualitySelect, diagnosticsButton, hierarchyList, treeFilterInput, hiddenList, summaryPanel, coveragePanel, canvasHost, canvasMessage, rightPanel, propertiesTab, tagsTab, clipTab, diagnosticsTab, propertiesPanel, tagsPanel, clipPanel, diagnosticsPanel, statusText, schemaText, sourceText, nodeText, primitiveText, decodedText, unsupportedText, failedText, componentText, diagnosticsText, qualityText, planEntryText, planDiagnosticText, selectToolButton, orbitToolButton, panToolButton, fitButton, fitSelectionButton, isoViewButton, topViewButton, frontViewButton, sideViewButton, hideButton, unhideButton, showAllButton, isolateButton, clipSelectionButton, clipModelButton, clipPlaneButton, clipClearButton, tagCreateButton, tagViewButton, tagImportButton, tagExportButton, marqueeZoomButton, measureToolButton, measureReadout, selectedText, objectsText, visibleText, hiddenText, clipText, tagText, coordText, unitsText };
}
